...
import kitFamilyImg from "../../../assets/kit_family.png";
        ...
        <div className="flex flex-col lg:flex-row gap-10 lg:gap-16">
          <article className="flex-1 flex flex-col">
            ...
            <div className="space-y-3 text-gray-500 text-[15px] leading-relaxed">
              <p>
                ...
                embrague ha madurado en un programa de 12 fábricas, con
                certificación ISO/TS16949.
              </p>
              <p>
                Ofrecemos un programa completo para Aftermarket siguiendo la
                pauta de OEM, bajo especificaciones de cada fabricante de Equipo
                Original.
              </p>
              ...
              <p>
                Componentes elaborados con materia prima de alta calidad y los
          ...
          <article className="flex-1 flex flex-col">
            ...
            <p className="text-gray-500 text-[15px] leading-relaxed">
              Durante el proceso de fabricación, los componentes son sometidos a
              rigurosos procedimientos: prueba de resistencia y dureza, fatiga y
              rendimiento hasta 5 millones de ciclos, pruebas de balance,
              resistencia a altas temperaturas, compresión, torsión y prueba
              final del conjunto en banco de ensamble según protocolos QCT25 y
              QCT27-2014.
            </p>
          </article>
        </div>
